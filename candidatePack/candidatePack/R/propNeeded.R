#' Proportion of remaining delegates necessary to win the nomination
#' 
...
#'
#' @return The proportion of the remaining delegates still that a given candidate needs to win in order to get her party's nomination.
#' 
